...
export const environment = {
  ...
  api_url_products: apiUrl + '/api/v1/products/search-by-admin',
  ...
  LOGIN_API: apiUrl + '/api/v1/auth/login',
  GOOGLE_LOGIN_API: apiUrl + '/api/v1/auth/google',
  ...
  URL_API_GETNOFICATION_BY_USER: apiUrl + '/api/v1/nofications'
};
